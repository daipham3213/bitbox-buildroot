#
# Makefile
# bitbox-buildroot top-level Makefile
#
...
release: check-project
	...
	tar -C build/bitbox/images --transform='flags=r;s|bzImage|buildroot-bzimage68_v86.bin|' -cjf bitbox-buildroot-$(RELEASE_VER).tar.bz2 bzImage rootfs.cpio rootfs.tar
